...
const login = async (req, res) => {
    ...
    try {
        ...
        // Set Auth Cookie
        // Note: We do NOT set 'domain' here because the API (on Railway) cannot set a cookie for .thecrownside.com
        // relying on SafeSite=None; Secure to allow it as a Third-Party cookie.
        res.cookie('token', token, {
            httpOnly: true,
            secure: true, // Always secure for SameSite=None
